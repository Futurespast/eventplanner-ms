...
public class GlobalControllerExceptionHandler {
   ...
   @ResponseStatus(UNPROCESSABLE_ENTITY)
    ...
    @ResponseStatus(UNPROCESSABLE_ENTITY)
    @ExceptionHandler(PastAvailableDateException.class)
    public HttpErrorInfo handlePastAvailableDateException(WebRequest request, PastAvailableDateException ex) {
        return createHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
    }
